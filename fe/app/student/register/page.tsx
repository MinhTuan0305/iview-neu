    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-10 px-5">
      <div className="bg-white p-12 shadow-lg w-full max-w-[420px] border border-black/8">
        <div className="text-center mb-6">
          <h2 className="text-[#0065ca] text-3xl font-semibold uppercase tracking-wide mb-2">Đăng Ký Sinh Viên</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="studentCode" className="font-medium text-[#202124]">Mã sinh viên <span className="text-red-500">*</span></label>
            <div className="relative">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="className" className="font-medium text-[#202124]">Lớp</label>
            <div className="relative">
              <i className="fas fa-users absolute left-3 top-1/2 -translate-y-1/2 text-[#5f6368]"></i>
              <input 
                type="text" 
                id="className"
                value={className}
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="courseYear" className="font-medium text-[#202124]">Khóa học</label>
            <div className="relative">
              <i className="fas fa-calendar absolute left-3 top-1/2 -translate-y-1/2 text-[#5f6368]"></i>
              <input 
                type="text" 
                id="courseYear"
                value={courseYear}
          ...
          <div className="text-center text-[#5f6368] mt-5">
            Đã có tài khoản? <Link href="/student/login" className="text-[#0065ca] font-medium hover:underline">Đăng nhập ngay</Link>
          </div>
        </form>
